    ...
    public partial class ModBrowserForm : Form
    {
        ...
        private async Task RefreshModsAsync()
        {
            ...
            try
            {
                ...
                if (registry != null)
                {
                    _allMods = registry.Mods.Where(m => m.IsEnabled).ToList();
        ...
        private void UpdateDetailsPanel(RemoteModInfo mod)
        {
            ...
            {
                _modVersionLabel.Text = $"Version: v{mod.Version}";
        ...
        private async Task InstallSelectedModAsync()
        {
            ...
            try
            {
                var result = await _modDownloader.DownloadAndInstallModAsync(_selectedMod, progress =>
                {
