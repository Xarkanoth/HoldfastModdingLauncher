...
namespace HoldfastModdingLauncher
{
    public partial class MainForm : Form
    {
        ...
        private void UpdateModDetails(string modFileName)
        {
            ...
            {
                _detailsDescLabel.Text = mod.Description;
            }
            else if (manifest != null && !string.IsNullOrEmpty(manifest.Description))
            {
                _detailsDescLabel.Text = manifest.Description;
            }
            else
            {
                _detailsDescLabel.Text = "No description available.";
            }
